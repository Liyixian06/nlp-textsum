...
if __name__ == '__main__':
    ...
    parser.add_argument("-onmt_path", default='../data/cnndm_data/cnndm')
    parser.add_argument("-data_path", default='../data/')
    parser.add_argument("-raw_path", default='../line_data')
    parser.add_argument("-vocab_path", default='../data/cnndm_data/spm.cnndm.model')
    ...
    parser.add_argument("-inter_layers", default=3, type=int)
    ...
    parser.add_argument("-report_every", default=2000, type=int)
